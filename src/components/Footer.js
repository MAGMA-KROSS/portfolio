      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          ...
          <div className="flex-shrink-0">
            <h3 className="text-2xl font-bold">Kumar Abi</h3>
            <p className="text-sm text-gray-400 mt-1">Web Developer | Data Science Enthusiast</p>
          </div>
        ...
        <div className="mt-10 pt-8 border-t border-gray-800 text-center text-sm text-gray-500">
          <p>&copy; 2025 Kumar Abi. All rights reserved.</p>
        </div>
      </div>
    </motion.footer>
  );
