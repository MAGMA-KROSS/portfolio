      ...
      <header className="text-gray-500 hidden md:block body-font backdrop-blur-md border-1 border-gray-200/40 rounded-full">
        ...
        <div className="container mx-auto flex flex-wrap p-5 justify-center md:flex-row items-center">
          ...
          <nav className="md:ml-auto md:mr-auto flex text-white flex-wrap items-center text-base justify-center">
            <Link
              href="/"
              className="mr-5 hover:text-[#00b8db] transition-all duration-250 relative group"
            >
              Home
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-[#00b8db] scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out"></span>
            </Link>
            <Link
              href="#About"
              className="mr-5 hover:text-[#00b8db] transition-all duration-250 relative group"
      ...
      <header className="text-gray-500 relative block md:hidden z-25 body-font  ">
        <div className="container mx-auto flex flex-wrap p-5 justify-center flex-col ">
          ...
          >
            <Link
              href="/"
              className="mr-5 border-1 border-gray-200/40 p-2 pl-5 hover:text-[#00b8db] text-center transition-all duration-250"
            >
              Home
            </Link>
            <Link
